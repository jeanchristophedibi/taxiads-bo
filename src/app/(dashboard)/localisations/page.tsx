  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card overflow-hidden">
        ...
        <LocationsTable search={search || undefined} isActive={isActive} onEdit={can('locations.write') ? openEdit : undefined} />
      </div>

      {modal.open && can('locations.write') && <LocationForm location={modal.location} onClose={closeModal} />}
    </div>
  );
}
